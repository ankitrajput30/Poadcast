...
const Upload = ({ setUploadOpen }) => {
  ...
  const uploadFile = async (file, index) => {
    ...
    formData.append("upload_preset", "mypod_preset"); // Ensure you create an unsigned upload preset in Cloudinary

    try {
      const response = await axios.post(
        "https://api.cloudinary.com/v1_1/dirfh5mmo/upload",
        formData,
        {
