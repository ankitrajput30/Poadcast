...
const PodcastDetails = () => {
  ...
  const favoritpodcast = async () => {
    ...
    try {
      ...
      console.error("Error favoriting podcast:", err);
      dispatch(
        openSnackbar({
          message: err?.response?.data?.message || "Failed to favorite podcast",
          severity: "error",
        })
      );
    } finally {
  ...
  const getPodcast = async () => {
    ...
    try {
      ...
      dispatch(
        openSnackbar({
          message: err?.response?.data?.message || "Failed to fetch podcast",
          severity: "error",
        })
      );
    } finally {
